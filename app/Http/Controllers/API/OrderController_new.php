    ...
    public function createPaymentIntent(Request $request)
    {
        ...
        try {
            ...
            foreach ($items as $itemData) {
                ...
                if (!$vendor || !$vendor->canAcceptPayments()) {
                ...
                $commissionPercent = $item->commission ?? 10.00;
            ...
            foreach ($vendorOrders as $vendorId => $vendorData) {
                ...
                $order = Order::create([
                    ...
                    'commission_amount' => $vendorData['commission'],
                    'vendor_amount' => $vendorData['vendor_amount'],
                    'currency' => 'usd',
                ...
                $commissionInCents = (int)($vendorData['commission'] * 100);
