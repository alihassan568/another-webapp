<x-app-layout>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
            <div>
                <h2 class="font-bold text-3xl text-gray-900 dark:text-white leading-tight">
                    {{ $user->role === 'business' ? __('Vendor Details') : __('User Details') }}
                </h2>
    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 {{ $user->role === 'business' ? 'lg:grid-cols-3' : '' }} gap-6">
                        ...
                        <div class="px-6 pb-6">
                            ...
                            <div class="text-center mb-6">
                                ...
                                <p class="text-gray-600 dark:text-gray-400 mb-3">
                                    <span class="capitalize">{{ $user->role }}</span> ID: #{{ $user->id }}
                                </p>
                                ...
                                @if($user->blocked_at)
                                    <span class="inline-flex items-center px-4 py-2 text-sm font-semibold rounded-full bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200">
                                        ...
                                        Blocked Since {{ $user->blocked_at->diffForHumans() }}
                                    </span>
                                @else
                            ...
                            <div class="space-y-3 mb-6">
                                ...
                                <div class="flex items-start text-sm">
                                    ...
                                    <span class="text-gray-900 dark:text-white">{{ $user->address ?? 'Not provided' }}</span>
                                </div>
                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    <span class="text-gray-900 dark:text-white">Joined {{ $user->created_at->format('M d, Y') }}</span>
                                </div>
                            </div>
                        ...
                        <div class="p-6">
                            @if($user->items->count() > 0)
                                ...
                                <div class="mt-4 text-center">
                                    <a href="{{ route('admin.items') }}?vendor_id={{ $user->id }}" class="text-blue-600 dark:text-blue-400 hover:underline text-sm font-medium">
