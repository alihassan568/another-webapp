<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
            ...
            <div class="flex items-center space-x-2 mt-4 sm:mt-0">
                <button 
                    @click="if({{ $roles->count() === 0 ? 'true' : 'false' }}) { showWarningModal = true } else { showInviteModal = true }"
                    class="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-purple-600 hover:to-pink-600 text-white rounded-xl font-semibold transition-all duration-300 flex items-center space-x-2">
    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen" x-data="{ showInviteModal: false, showWarningModal: false }">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    ...
                                    <button 
                                        @click="if({{ $roles->count() === 0 ? 'true' : 'false' }}) { showWarningModal = true } else { showInviteModal = true }"
                                        class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold transition-colors">
