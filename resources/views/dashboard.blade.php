            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('admin.activity-logs.index') }}" class="flex items-center p-3 rounded-xl hover:bg-yellow-50 dark:hover:bg-yellow-700 transition-colors group">
                            ...
                            <div>
                                <p class="font-semibold text-gray-900 dark:text-white">Track Admin Activity</p>
                                <p class="text-sm text-gray-500 dark:text-gray-400">View admin activity logs</p>
                            </div>
                        </a>
